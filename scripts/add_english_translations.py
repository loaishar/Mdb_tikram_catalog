...
def create_product_translations():
    ...
    # Save translations
    with open_data('product_translations.json', 'w', encoding='utf-8') as f:
...
def update_mongodb_with_translations():
    ...
    with open_data('product_translations.json', 'r', encoding='utf-8') as f:
    ...
    with open_data('mongodb_updates.json', 'w', encoding='utf-8') as f:
