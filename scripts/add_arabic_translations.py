...
def create_product_translations():
    ...
    # Save translations
    with open_data('product_translations_arabic.json', 'w', encoding='utf-8') as f:
...
def update_mongodb_with_arabic_translations():
    ...
    with open_data('product_translations_arabic.json', 'r', encoding='utf-8') as f:
    ...
    with open_data('mongodb_updates_arabic.json', 'w', encoding='utf-8') as f:
