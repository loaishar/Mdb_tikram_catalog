...
def load_json_files():
    ...
    with open_data('products_import.json', 'r', encoding='utf-8') as f:
        products = json.load(f)
    
    with open_data('offers_import.json', 'r', encoding='utf-8') as f:
        offers = json.load(f)
...
def prepare_batch_import():
    ...
    with open_data('products_batch_1.json', 'w', encoding='utf-8') as f:
